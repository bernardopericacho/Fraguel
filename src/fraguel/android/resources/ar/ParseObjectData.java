...
import fraguel.android.ar.animation.KeyFrame;
import fraguel.android.ar.core.Object3d;
import fraguel.android.ar.vos.Color4;
import fraguel.android.ar.vos.Face;
import fraguel.android.ar.vos.Number3d;
import fraguel.android.ar.vos.Uv;
import fraguel.android.resources.ar.AParser.BitmapAsset;
import fraguel.android.resources.ar.AParser.Material;
import fraguel.android.resources.ar.AParser.TextureAtlas;
...
public class ParseObjectData {
	...
	public ParseObjectData(ArrayList<Number3d> vertices,
			ArrayList<Uv> texCoords, ArrayList<Number3d> normals) {
	...
	public AnimationObject3d getParsedObject(TextureAtlas textureAtlas,
			HashMap<String, Material> materialMap, KeyFrame[] frames) {
		AnimationObject3d obj = new AnimationObject3d(numFaces * 3, numFaces,
				frames.length);
		obj.name(name);
	...
	public Object3d getParsedObject(HashMap<String, Material> materialMap,
	...
	private void parseObject(Object3d obj,
			HashMap<String, Material> materialMap, TextureAtlas textureAtlas) {
	...
	public void calculateFaceNormal(ParseObjectFace face) {
		...
		double normFactor = Math.sqrt((normal.x * normal.x)
